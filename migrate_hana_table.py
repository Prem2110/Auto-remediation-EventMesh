...
SOURCE_CONFIG: dict = {
    "address":                "fdddfefe-e600-4b7f-b032-4f8fd05ec060.hna0.prod-us10.hanacloud.ondemand.com",
    "port":                   443,
...
TARGET_CONFIG: dict = {
    "address":                "6eee8a49-23f9-42c3-a4b1-125f75146bf3.hna1.prod-us10.hanacloud.ondemand.com",
    "port":                   443,
...
def hana_connect(cfg: dict, label: str) -> Generator:
    ...
    conn = None
    try:
        log.info("[%s] Connecting to %s:%s …", label, cfg["address"], cfg["port"])
