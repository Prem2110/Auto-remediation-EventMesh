...
const PIPELINE_META: Record<string, { icon: IconName; desc: string; gradient: string; accent: string }> = {
  observer:     { icon:"eye",           desc:"Receives errors from SAP Cloud ALM, deduplicates, triggers the remediation pipeline.", gradient:"linear-gradient(135deg,#0f172a 0%,#1e40af 100%)", accent:"#60a5fa" },
